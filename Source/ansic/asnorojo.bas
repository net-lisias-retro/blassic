...
64 rem Adaptacion a Blassic por Julian Albo.
70 rem
80 mode 1
110 rem
...
240 cls: for i= 1 to 40: print mid$ (a1$, i, 1);: pause 100: next: print: for i= 1 to 40: print "-";: pause 100: next
...
330 print: print: print: for i= 1 to 16: print mid$ (a2$, i, 1);: pause 100: next: print: print
340 print: print tab (13);: for i= 1 to 15: print mid$ (a3$, i, 1);: pause 100:next
...
570 locate 23, 1: print "Numero de jugadas "; c; " enganchar": locate 20, 1: get a$: on -(a$ = g$) goto 610: on -(a$ = d$) goto 630: on -(a$ = b$) goto 650: on -(a$ = h$) goto 670: on -(a$ <> v$) goto 520: goto 690
